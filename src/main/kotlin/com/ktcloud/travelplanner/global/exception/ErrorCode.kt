...
enum class ErrorCode(
	...
	MAPS_SERVICE_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, "지도 서비스에 일시적으로 연결할 수 없습니다."),
	IDENTITY_SERVICE_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, "사용자 서비스에 일시적으로 연결할 수 없습니다."),
